    ...
    function json_error()
    {
        ...
        switch (json_last_error()) {
            ...
            case JSON_ERROR_DEPTH:
                $msg['bool'] = false;
                $msg['msg'] = 'json Maximum stack depth exceeded';
                break;
            case JSON_ERROR_STATE_MISMATCH:
                $msg['bool'] = false;
                $msg['msg'] = 'json Underflow or the modes mismatch';
                break;
            ...
            case JSON_ERROR_SYNTAX:
                $msg['bool'] = false;
                $msg['msg'] = 'json Syntax error, malformed JSON';
                break;
            case JSON_ERROR_UTF8:
                $msg['bool'] = false;
                $msg['msg'] = 'json Malformed UTF-8 characters, possibly incorrectly encoded';
                break;
            default:
                $msg['bool'] = true;
                $msg['msg'] = 'ok';
